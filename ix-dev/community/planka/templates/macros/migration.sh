...
function mark_completed() {
  ...
  echo -e "Keep this file to prevent the migration from running again.\n" >> /app/data/.migration_completed
  echo -e "It is only safe to remove this file once migration handling code is removed" >> /app/data/.migration_completed
  echo -e "from the TrueNAS app and you have upgraded to a newer version of the TrueNAS app." >> /app/data/.migration_completed
}
